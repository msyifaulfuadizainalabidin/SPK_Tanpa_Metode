      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li>
              <a href="user.php">Pembobotan Kriteria</a>
            </li>
            <li>
              <a href="dataalternatif.php">Data Kriteria</a>
            </li>   
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-table"></i> Data Nilai Alternatif</div>
      <div class="card-body">
        <div class="card-body">
          ...
          <div class="modal fade" id="exampleModall" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body"><input class="form-control" type="text" name="namacustomer" value="" placeholder="Masukkan Nama Pelanggan" ></div>
